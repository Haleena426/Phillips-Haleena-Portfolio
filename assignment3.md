...
var divElement = document.getElementById('viz1700203857959');
...
{ vizElement.style.width='1000px';vizElement.style.height='827px';} else { vizElement.style.width='100%';vizElement.style.height='727px';}
